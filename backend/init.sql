-- Schema bootstrap for Boonbaan MikroTik Manager
-- Auto-loaded by postgres on first start (mounted to /docker-entrypoint-initdb.d/).
-- migrate.js also runs these idempotently at app boot, so this file is a fast-path.
